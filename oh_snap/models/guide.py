...
class Guide(models.Model):
	...
	# Union
	uuid 					= models.Attribute(indexed=True, required=True)
	seq 					= models.Integer(indexed=True)
	short 					= models.Attribute(indexed=True)
	like_count 				= models.Integer(indexed=True)
	is_liked 				= models.BooleanField(indexed=True)
	view_count 				= models.Integer(indexed=True)
	guide_comment_count 	= models.Integer(indexed=True)
	supplies_comment_count 	= models.Integer(indexed=True)
	total_comment_count 	= models.Ineger(indexed=True)
	topics 					= models.ListField(unicode, indexed=True)

	# Intersect for UUID fetch result
	last_edited 			= models.Integer(indexed=True)
	...
	publish_date 			= models.Integer(indexed=True)
